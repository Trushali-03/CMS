...
$query=mysqli_query($con,"select ID from tbdeliveryagent where ID='$staffid' and DAPassword='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbldeliveryagent set DAPassword='$newpassword' where ID='$staffid'");
