...
$query=mysqli_query($con,"delete from tblstaff where ID='$bid'");
if($query){
...
<a href="manage-staff.php?activeid=<?php echo $row['ID'];?>" title="Active this account" onclick="return confirm('Do you really want to Active this account.');" class="btn btn-success">Active</a>
    <?php } ?>
       ...
       <a href="manage-staff.php?action=delete&&bid=<?php echo $row['ID']; ?>"  title="Delete this record" onclick="return confirm('Do you really want to delete this record?');" class="btn btn-danger">Delete </a>
                  </td>
                </tr>
                <?php 
$cnt=$cnt+1;
