...
echo "<script type='text/javascript'> document.location = 'courier.php'; </script>";
} else {
                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h3 class="m-t-0 header-title">New Couriers</h3>
                                    <hr />
...
<tr><th style="color:red" colspan="6"> No Record Found</th></tr>
<?php } ?>
