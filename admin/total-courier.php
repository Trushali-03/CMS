...
echo "<script type='text/javascript'> document.location = 'total-courier.php.php'; </script>";
} else {
...
<?php endif;?>
               ...
               <a href="courier.php?action=delete&&cid=<?php echo $row['RefNumber']; ?>"  title="Delete this record" onclick="return confirm('Do you really want to delete this record?');" class="btn btn-danger">Delete </a>                      
