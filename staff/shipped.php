...
echo "<script type='text/javascript'> document.location = 'shipped.php'; </script>";
} else {
...
<div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h3 class="m-t-0 header-title">Shipped Couriers</h3>
                                    <hr />
 ...
 <?php
$ret=mysqli_query($con,"select *from tblcourier where Status='Shipped'");
$cnt=1;
...
<?php endif;?>
               ...
               <a href="shipped.php?action=delete&&cid=<?php echo $row['RefNumber']; ?>"  title="Delete this record" onclick="return confirm('Do you really want to delete this record?');" class="btn btn-danger">Delete </a>                      
