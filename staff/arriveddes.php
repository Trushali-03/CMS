...
echo "<script type='text/javascript'> document.location = 'arriveddes.php'; </script>";
} else {
...
<div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h3 class="m-t-0 header-title">Arrived at Destination Couriers</h3>
                                    <hr />
 ...
 <?php
$ret=mysqli_query($con,"select *from tblcourier where Status='Arrived at Destination'");
$cnt=1;
...
<?php endif;?>
               ...
               <a href="arriveddes.php?action=delete&&cid=<?php echo $row['RefNumber']; ?>"  title="Delete this record" onclick="return confirm('Do you really want to delete this record?');" class="btn btn-danger">Delete </a>                      
...
$cnt=$cnt+1;
    ...
    <tr>
        <th style="color:red" colspan="6"> No Record Found</th>
    </tr>
<?php } ?>
