...
<h4 class="m-t-0 header-title">Search By Reference Number / Sender name / Sender Contact no./ RecipientName / Recipient Contact no</h4>
<hr />
                                    <div class="form-group">
<label for="disabledSelect">By Reference Number / Sender name / Sender Contact no./ RecipientName / Recipient Contact no</label>
...
$sdata=$_POST['searchdata'];
 ...
 <?php
$ret=mysqli_query($con,"select *from tblcourier where RefNumber like '$sdata%' || SenderName like '$sdata%' || SenderContactnumber like '$sdata%' || RecipientName like '$sdata%' || RecipientContactnumber like '$sdata%'");
