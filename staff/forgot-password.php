    ...
    echo $msg;
                        ...
                        <form class="m-t-20" action="" method="post" name="submit">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <input class="neumorphic neumorphic-input" type="email" required="" name="email" placeholder="Staff Email">
                                </div>
                            </div>

                            <div class="form-group row">
                                <div class="col-12">
                                    <input class="neumorphic neumorphic-input" type="text" name="contactno" required="" placeholder="Staff Mobile Number">
                                </div>
                            </div>
