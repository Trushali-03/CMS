        ...
        <div class="neumorphic neumorphic-card">
            <div class="text-center m-t-20">
                        <!-- <a href="../index.php" class="logo">
                            ...
                            <h1 style="margin-bottom: 30px;">CMS|| Staff Login</h1>
                        </a>
                    </div>
  ...
  <!-- </p> -->
                        <form class="m-t-20" action="" method="post" name="login">
                            ...
                            <div class="form-group row">
                                <div class="col-12">
                                    <input class="neumorphic neumorphic-input" type="email" required="" name="staffemail" placeholder="Staff Email">
                                </div>
                            </div>
                            ...
                            <div class="form-group text-center row m-t-10">
                                <div class="col-12">
                                    <button class="neumorphic neumorphic-button" type="submit"
